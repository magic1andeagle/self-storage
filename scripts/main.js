...
window.addEventListener("DOMContentLoaded", () => {
  ...
  modal_nameInput.addEventListener("input", () =>
    onValidate([modal_nameInput, modal_phoneInput], modal_btn)
  );
  modal_phoneInput.addEventListener("input", () =>
    onValidate([modal_nameInput, modal_phoneInput], modal_btn)
  );
...
helpButtons.forEach((btn) => {
  const questionImg = btn.parentElement.children[1];
